...
*For the c7rpimyth project;I'll put the source's here git later after it stablizes, for now the rpms/srpms are on SF.
...
Example Input:
     ...
     -bash-4.2# kpartx -avs c7rpiMyth.raw.img
...
./revfat+4rpi.sh c7rpiMyth.raw.img AEIO-U12
...
++ cut -c1-8
+ TTRIM=AEIO-U12
+ echo 'LABEL=AEIO-U12          /boot             vfat    defaults,noatime        0 0'
+ echo ...
...
+ echo 'Using AEIO-U12 as bootlabel name for image rootfs /etc/fstab'
Using AEIO-U12 as bootlabel name for image rootfs /etc/fstab
+ echo ...
...
+ sleep 3
+ echo ...
...
LABEL=AEIO-U12          /boot             vfat    defaults,noatime        0 0
+ sleep 3
+ echo ...
...
+ echo ...
...
/dev/mapper/loop0p1: SEC_TYPE="msdos" LABEL="AEIO-U12" UUID="35A6-41C6" TYPE="vfat" 
