 ...
 *You dont technically have to use UPPERCASE but you might want to, eg. incase you want to read the vfat part on old windows machine that may not support LOWERCASE labels or some other strange old os."
